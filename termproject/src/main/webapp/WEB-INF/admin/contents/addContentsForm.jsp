...
<body>
    ...
    <option value="romance">로맨스</option>
					...
					<td>
						<input type="number" class="input-normal" name="running" maxlength="50" placeholder="러닝타임을 입력해주세요.">					
					</td>
					<th>줄거리<em class="red">*</em></th>
					<td>
						<input type="text" class="input-normal" name="summary" maxlength="50" placeholder="러닝타임을 입력해주세요.">					
					</td>
					</tr>
					<tr>
